...
def main():
    ...
    parser.add_argument("-fn", "--file-name", type=str, default="mobile_net_v2_adam",
                        help="file name, default = mobile_net_v2_adam")
    parser.add_argument("-n", "--n-epochs", type=int, default=800,
